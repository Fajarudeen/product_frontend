...
function ProductCard({ product }) {
    ...
    return (
        <>
            ...
            < Row >
                <Col>
                    <Link style={{ textDecoration: "none", color: "white" }} to={`/view/${product._id}`}>
                        <Card className="m-3">
                            <Card.Img variant="top" className="p-2" src={`http://localhost:5000/uploads/${product.files[0].filename}`}
                                onError={(e) => {
